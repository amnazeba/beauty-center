...
--
-- Host: localhost    Database: beautycenter
-- ------------------------------------------------------
...
CREATE TABLE `appointments` (
  ...
  CONSTRAINT `appointments_ibfk_4` FOREIGN KEY (`admin_id`) REFERENCES `admins` (`admin_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Dumping routines for database 'beautycenter'
--
...
-- Dump completed on 2025-11-02 13:19:40
